	...
	<div class="container">
        <div class="items">
                <form class="form" action="/post/insert" method="post">
                    ...
                    <div class="inputBox contents"><textarea name="contents" placeholder = "Contents" id="contents" cols="30" rows="10"></textarea></div>
